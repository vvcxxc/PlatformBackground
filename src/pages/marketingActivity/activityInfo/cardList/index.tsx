...
const data = [
  {
    key: '1',
    num: '1',
    activityName: '2019双11鹰潭区域免费推广',
    activityFormWork: '免费推广',
    activityArea: '江西省鹰潭市',
    ...
    class ActivityInfo extends Component<Props> {
      ...
      render() {
        ...
        const columns = [
          ...
          {
            title: '活动模板',
            dataIndex: 'activityFormWork',
            key: 'activityFormWork',
            sorter: (a, b) => a.activityFormWork.length - b.activityFormWork.length,
            sortOrder: sortedInfo.columnKey === 'activityFormWork' && sortedInfo.order,
            ellipsis: true,
          },
          {
            title: '招募时间',
